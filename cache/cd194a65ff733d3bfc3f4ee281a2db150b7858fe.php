            ...
            <div class="container max-w-8xl mx-auto px-4 lg:px-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex w-auto">
                        ...
                        <a href="https://github.com/daguilarm/belich-documents" class="flex-1 mr-2"><?php echo e($page->locate === 'en' ? 'Documents' : 'Documentos'); ?></a> <span class="mx-2">/</span>
                        <a href="https://github.com/daguilarm/belich-dashboard" class="flex-1 mr-2"><?php echo e($page->locate === 'en' ? 'Examples' : 'Ejemplos'); ?></a>
                    </div>
                </div>
